...
<template>
  <div>
    <!-- <TheWelcome /> -->
    <div class="relative">
      <img src="../assets/images/landing-image.png" alt="" class="h-screen w-screen object-fit" />
      ...
      <div class="absolute flex inset-0 items-center justify-center text-5xl text-white">
        <p class="max-w-2xl">
          Driving sustainable development with international expertise and innovation.
        </p>
      </div>
    </div>
  </div>
